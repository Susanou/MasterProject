...
def train_local(train_x, train_y, learners, i):
    ...
    try:
        ...
        model.save(f'models/minst/model_{i}.tf')
...
for i in range(len(trainsets)):
    ...
    learners.append(load_model(f'models/minst/model_{i}.tf'))
...
model.save(f'models/minst/target.tf')
del model
target = load_model('models/minst/target.tf')
